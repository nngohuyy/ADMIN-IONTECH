...
import {
  Plus as PlusIcon,
  DotsThreeVertical as VerticalDotsIcon,
...
export const CustomTable = <T,>({
  ...
  const renderCell = React.useCallback((user: any, columnKey: React.Key) => {
    const cellValue = user[columnKey as keyof typeof data];
    ...
    switch (columnKey) {
      case "name":
        return (
          <User
            ...
            description={user.brand + user.category}
            name={cellValue}
          >
      ...
      case "netPrice":
        return (cellValue as number).toLocaleString("vi-VN", {
          style: "currency",
          currency: "VND",
        });
      default:
        ...
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Button
              color="primary"
              endContent={<PlusIcon />}
              onPress={() => navigate("/products/add-product")}
            >
              Add New
            </Button>
          </div>
